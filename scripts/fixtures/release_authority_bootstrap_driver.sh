...
assert_no_bootstrap_transients() {
    ...
    for transient in \
        ...
        /opt/.syntaur-genesis-validator.recovery-v4-g6 \
        /run/syntaur-release-authority-g1-g2-g3-g4-g5-g6-g7-recovery.snapshot \
        /etc/syntaur/.release-authority.recovery-v5-g1-g2-g3-g4-g5-g6-g7 \
        /usr/local/bin/.syntaur-ship.recovery-v5-g1-g2-g3-g4-g5-g6-g7 \
        /opt/.syntaur-build-authority-provision.recovery-v5-g7 \
        /opt/.syntaur-genesis-validator.recovery-v5-g7 \
        /run/syntaur-release-authority-g1-g2-g3-g4-g5-g6-g7-g8-recovery.snapshot \
        /etc/syntaur/.release-authority.recovery-v6-g1-g2-g3-g4-g5-g6-g7-g8 \
        /usr/local/bin/.syntaur-ship.recovery-v6-g1-g2-g3-g4-g5-g6-g7-g8 \
        /opt/.syntaur-build-authority-provision.recovery-v6-g8 \
        /opt/.syntaur-genesis-validator.recovery-v6-g8 \
        /run/syntaur-release-authority-g1-g2-g3-g4-g5-g6-g7-g8-g9-recovery.snapshot \
...
run_recovery_fixture() {
    ...
    elif [[ $scenario == recovery-g7 ]]; then
        recovery="$bootstrap_root/bootstrap-release-authority-g1-g2-g3-g4-g5-g6-g7-recovery-v5.sh"
        stage_action=stage-g7-build-authority
        genesis_label=G7
        genesis_slug=g7
        genesis_dir=$g7_dir
        genesis_authority_commit=$RECOVERY_G7_AUTHORITY_COMMIT
        genesis_authority_git_tree=$RECOVERY_G7_AUTHORITY_GIT_TREE
        genesis_manifest_sha256=$RECOVERY_G7_MANIFEST_SHA256
        genesis_provisioner_sha256=$RECOVERY_G7_PROVISIONER_SHA256
        genesis_shipper_sha256=$RECOVERY_G7_SHIPPER_SHA256
        genesis_source_date_epoch=$RECOVERY_G7_SOURCE_DATE_EPOCH
        active_generation=7
        active_dir=$g7_dir
        active_provisioner_sha256=$RECOVERY_G7_PROVISIONER_SHA256
        active_shipper_sha256=$RECOVERY_G7_SHIPPER_SHA256
        predecessor_material=$g6_dir
        authority_parent_commit=$RECOVERY_G6_AUTHORITY_COMMIT
        authority_parent_tree=$RECOVERY_G6_AUTHORITY_GIT_TREE
        catalog_authority_commit=$RECOVERY_G2_AUTHORITY_COMMIT
        recovery_args+=(
            --g4-dir "$g4_dir"
            --g5-dir "$g5_dir"
    ...
    elif [[ $scenario == recovery-g8 ]]; then
        recovery="$bootstrap_root/bootstrap-release-authority-g1-g2-g3-g4-g5-g6-g7-g8-recovery-v6.sh"
        stage_action=stage-g8-build-authority
        genesis_label=G8
        genesis_slug=g8
        genesis_dir=$g8_dir
        genesis_authority_commit=$RECOVERY_G8_AUTHORITY_COMMIT
        genesis_authority_git_tree=$RECOVERY_G8_AUTHORITY_GIT_TREE
        genesis_manifest_sha256=$RECOVERY_G8_MANIFEST_SHA256
        genesis_provisioner_sha256=$RECOVERY_G8_PROVISIONER_SHA256
        genesis_shipper_sha256=$RECOVERY_G8_SHIPPER_SHA256
        genesis_source_date_epoch=$RECOVERY_G8_SOURCE_DATE_EPOCH
        active_generation=8
        active_dir=$g8_dir
        active_provisioner_sha256=$RECOVERY_G8_PROVISIONER_SHA256
        active_shipper_sha256=$RECOVERY_G8_SHIPPER_SHA256
        predecessor_material=$g7_dir
        authority_parent_commit=$RECOVERY_G7_AUTHORITY_COMMIT
        authority_parent_tree=$RECOVERY_G7_AUTHORITY_GIT_TREE
        catalog_authority_commit=$RECOVERY_G2_AUTHORITY_COMMIT
        recovery_args+=(
            --g4-dir "$g4_dir"
            --g5-dir "$g5_dir"
    ...
    elif [[ $scenario == recovery-g9 ]]; then
        recovery="$bootstrap_root/bootstrap-release-authority-g1-g2-g3-g4-g5-g6-g7-g8-g9-recovery-v7.sh"
        stage_action=stage-g9-build-authority
        genesis_label=G9
        genesis_slug=g9
        genesis_dir=$g9_dir
        genesis_authority_commit=$RECOVERY_G9_AUTHORITY_COMMIT
        genesis_authority_git_tree=$RECOVERY_G9_AUTHORITY_GIT_TREE
        genesis_manifest_sha256=$RECOVERY_G9_MANIFEST_SHA256
        genesis_provisioner_sha256=$RECOVERY_G9_PROVISIONER_SHA256
        genesis_shipper_sha256=$RECOVERY_G9_SHIPPER_SHA256
        genesis_source_date_epoch=$RECOVERY_G9_SOURCE_DATE_EPOCH
        active_generation=9
        active_dir=$g9_dir
        active_provisioner_sha256=$RECOVERY_G9_PROVISIONER_SHA256
        active_shipper_sha256=$RECOVERY_G9_SHIPPER_SHA256
        predecessor_material=$g8_dir
        authority_parent_commit=$RECOVERY_G8_AUTHORITY_COMMIT
        authority_parent_tree=$RECOVERY_G8_AUTHORITY_GIT_TREE
        catalog_authority_commit=$RECOVERY_G2_AUTHORITY_COMMIT
        recovery_args+=(
            --g4-dir "$g4_dir"
            --g5-dir "$g5_dir"
    ...
    assert_recovery_layout() {
        ...
        for ((generation = 1; generation <= active_generation; generation++)); do
            case $generation in
                ...
                7)
                    material=$g7_dir
                    workflow=$RECOVERY_G7_WORKFLOW_COMMIT
                    ;;
                8)
                    material=$g8_dir
                    workflow=$RECOVERY_G8_WORKFLOW_COMMIT
                    ;;
                9)
                    material=$g9_dir
