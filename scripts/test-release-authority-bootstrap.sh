...
env \
    ...
    VERIFICATION_POLICY_REVISION="$G2_AUTHORITY_COMMIT" \
...
env \
    ...
    VERIFICATION_POLICY_REVISION="$G3_AUTHORITY_COMMIT" \
...
env \
    ...
    VERIFICATION_POLICY_REVISION="$G4_AUTHORITY_COMMIT" \
...
env \
    ...
    VERIFICATION_POLICY_REVISION="$G5_AUTHORITY_COMMIT" \
...
env \
    ...
    VERIFICATION_POLICY_REVISION="$G6_AUTHORITY_COMMIT" \
...
env \
    ...
    VERIFICATION_POLICY_REVISION="$G7_AUTHORITY_COMMIT" \
...
env \
    ...
    VERIFICATION_POLICY_REVISION="$G8_AUTHORITY_COMMIT" \
...
env \
    ...
    VERIFICATION_POLICY_REVISION="$G9_AUTHORITY_COMMIT" \
...
cp "$repo_root/scripts/fixtures/release_authority_g15_g16_driver.sh" \
    "$context/release-authority-g15-g16-driver.sh"
cp "$repo_root/scripts/recover-release-authority-g15-g16-canary-root-v1.sh" \
    "$context/recover-release-authority-g15-g16-canary-root-v1.sh"
