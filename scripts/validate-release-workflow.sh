...
authority_scripts=(
  ...
  scripts/fixtures/release_authority_g13_g14_driver.sh
  scripts/fixtures/release_authority_g14_g15_driver.sh
  scripts/fixtures/release_authority_g15_g16_driver.sh
